...
package net.mitrol.codec.memory;

import net.mitrol.codec.format.Format;
import net.mitrol.codec.scheduler.Clock;
import net.mitrol.codec.scheduler.DefaultClock;
...
public class Frame implements Delayed {
    ...
    public long getDelay(TimeUnit unit) {
        return unit.convert(timestamp + duration + 60000000L - clock.getTime(), TimeUnit.NANOSECONDS);
    }
